...
Ingredient.create(name: 'Halibut', quantity: 255, quantity_unit: 'oz', category_id: 1, par: 200, vendor_id: 4)
Ingredient.create(name: 'Scallop', quantity: 155, quantity_unit: 'oz', category_id: 1, par: 200, vendor_id: 4)
Ingredient.create(name: 'Half Chicken', quantity: 1, quantity_unit: 'ea', category_id: 1, par: 20, vendor_id: 4)
Ingredient.create(name: 'Short Rib', quantity: 16, quantity_unit: 'ea', category_id: 1, par: 20, vendor_id: 3)
Ingredient.create(name: 'Octopus', quantity: 80, quantity_unit: 'oz', category_id: 1, par: 40, vendor_id: 4)
...
Ingredient.create(name: 'Radicchio', quantity: 2, quantity_unit: 'lbs', category_id: 2, par: 20, vendor_id: 2)
Ingredient.create(name: 'Chinese Broccoli', quantity: 2, quantity_unit: 'lbs', category_id: 2, par: 20, vendor_id: 2)
Ingredient.create(name: 'Asparagus, White', quantity: 2, quantity_unit: 'lbs', category_id: 2, par: 20, vendor_id: 2)
Ingredient.create(name: 'Asparagus, Green', quantity: 2, quantity_unit: 'lbs', category_id: 2, par: 20, vendor_id: 2)
Ingredient.create(name: 'Morels', quantity: 2, quantity_unit: 'lbs', category_id: 2, par: 20, vendor_id: 7)
Ingredient.create(name: 'Chanterelles', quantity: 2, quantity_unit: 'lbs', category_id: 2, par: 20, vendor_id: 7)
Ingredient.create(name: 'Maitake Mushrooms', quantity: 2, quantity_unit: 'lbs', category_id: 2, par: 20, vendor_id: 7)
Ingredient.create(name: 'Fennel', quantity: 1, quantity_unit: 'lbs', category_id: 2, par: 10, vendor_id: 2)
Ingredient.create(name: 'Cauliflower', quantity: 1, quantity_unit: 'lbs', category_id: 2, par: 10, vendor_id: 2)
Ingredient.create(name: 'Celeriac', quantity: 1, quantity_unit: 'lbs', category_id: 2, par: 10, vendor_id: 2)
Ingredient.create(name: 'Carrot', quantity: 1, quantity_unit: 'lbs', category_id: 2, par: 10, vendor_id: 2)
Ingredient.create(name: 'Sunchoke', quantity: 1, quantity_unit: 'lbs', category_id: 2, par: 20, vendor_id: 2)
Ingredient.create(name: 'Apple, Honeycrisp', quantity: 2, quantity_unit: 'lbs', category_id: 2, par: 20, vendor_id: 2)
Ingredient.create(name: 'Apple, Granny Smith', quantity: 2, quantity_unit: 'lbs', category_id: 2, par: 20, vendor_id: 2)
Ingredient.create(name: 'Brioche', quantity: 2, quantity_unit: 'loaves', category_id: 4, par: 20, vendor_id: 1)
Ingredient.create(name: 'Oil, Olive', quantity: 1, quantity_unit: 'lbs', category_id: 4, par: 20, vendor_id: 1)
Ingredient.create(name: 'Vinegar, Raspberry', quantity: 1, quantity_unit: 'lbs', category_id: 4, par: 20, vendor_id: 1)
Ingredient.create(name: 'Vinegar, Apple Cider', quantity: 1, quantity_unit: 'lbs', category_id: 4, par: 20, vendor_id: 1)
Ingredient.create(name: 'Garlic', quantity: 1, quantity_unit: 'lbs', category_id: 2, par: 2, vendor_id: 2)
Ingredient.create(name: 'Onion, Red', quantity: 1, quantity_unit: 'lbs', category_id: 2, par: 20, vendor_id: 2)
Ingredient.create(name: 'Onion, Cippolini', quantity: 1, quantity_unit: 'lbs', category_id: 2, par: 20, vendor_id: 2)
Ingredient.create(name: 'Lemon', quantity: 1, quantity_unit: 'lbs', category_id: 2, par: 20, vendor_id: 2)
Ingredient.create(name: 'Egg, Yolk', quantity: 1, quantity_unit: 'cartons', category_id: 3, par: 20, vendor_id: 1)
Ingredient.create(name: 'Egg, Whole', quantity: 1, quantity_unit: 'cartons', category_id: 3, par: 20, vendor_id: 1)
Ingredient.create(name: 'Butter', quantity: 1, quantity_unit: 'lbs', category_id: 3, par: 20, vendor_id: 1)
Ingredient.create(name: 'Heavy Cream', quantity: 1, quantity_unit: 'qts', category_id: 3, par: 20, vendor_id: 1)
Ingredient.create(name: 'Whole Milk', quantity: 1, quantity_unit: 'gals', category_id: 3, par: 20, vendor_id: 1)
Ingredient.create(name: 'Oil, Canola', quantity: 1, quantity_unit: 'qts', category_id: 4, par: 20, vendor_id: 1)
